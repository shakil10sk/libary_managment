...
<div class="sidebar-header">
    {{-- <img src="{{ asset('public/assets/images/logo.svg') }}" alt="Library" srcset=""> --}}
    <img src="" alt="Library" srcset="">
</div>
<div class="sidebar-menu">
    <ul class="menu">
            ...
            <li class="sidebar-item">
                <a href="{{ route('add_member') }}" class='sidebar-link'>
                    <i data-feather="home" width="20"></i>
                ...
                <ul class="navbar-nav d-flex align-items-center navbar-light ml-auto">
                            ...
                            <ul class="list-group rounded-none">
                                <li class="list-group-item border-0 align-items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class='text-xs'>
                                            An order made by shakil hossain for product Samsung Galaxy S69
                                        </p>
                                    </div>
                                </li>
                            </ul>
                    ...
                    <li class="dropdown">
                        <a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                            ...
                            <div class="d-none d-md-block d-lg-inline-block">Hi, Shakil</div>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item" href="#"><i data-feather="user"></i> Account</a>
                            <a class="dropdown-item active" href="#"><i data-feather="mail"></i> Messages</a>
