...
function register_show(){
    ...
    if (error_status == true) {
        ...
        if(type == 1){
            ...
            window.open(url + "/trade/tax_register/" + from_date + "/" + to_date);

       }else if(type == 90){

            window.open(url + "/premises/register/" + from_date + "/" + to_date);

       }else if(type == 91){

            window.open(url + "/animal/register/" + from_date + "/" + to_date);

       }else if(type == 93){

            window.open(url + "/holdingnamjari/register/" + from_date + "/" + to_date);

       }else if(type == 94){

            window.open(url + "/roadexcavation/register/" + from_date + "/" + to_date);

       }else if(type == 95){

            window.open(url + "/emarot/register/" + from_date + "/" + to_date);

       } else if (type == 96){
            window.open(url + "/landuse/register/" + from_date + "/" + to_date);
       } else if (type == 100){
            window.open(url + "/market/accounts/register/" + from_date + "/" + to_date);
       }else if(type == 108){
            window.open(url + "/financial/register/" + from_date + "/" + to_date);
       }else if(type == 109){
          window.open(url + "/relationship/register/" + from_date + "/" + to_date);
       }else if(type == 110){
            window.open(url + "/dependent/register/" + from_date + "/" + to_date);
        }else if(type == 121){
            window.open(url + "/birth_registration/register/" + from_date + "/" + to_date);
        }
    }
...
function daily_report_show(){
    ...
    if (error_status == true) {
        ...
        if(type == 1){
            ...
            window.open(url + "/accounts/daily_deposit_expense_report/" + from_date + "/" + to_date);
...
function cashbook_show(){
     ...
     if (error_status == true) {
         ...
         if(type == 1){
             ...
             window.open(url + "/accounts/generelcashbook/" + from_date + "/" + to_date);

         }else if(type == 2){

              window.open(url + "/accounts/sthaborcashbook/" + from_date + "/" + to_date);

         }else if(type == 3){

              window.open(url + "/accounts/lgspcashbook/" + from_date + "/" + to_date);

         }else if(type == 4){

              window.open(url + "/accounts/birthdiecashbook/" + from_date + "/" + to_date);
