...
var death_table, fiscal_year_id, from_date, to_date;
 ...
 function applicant_list_search(){
    ...
    $("#death_applicant_table").dataTable().fnSettings().ajax.data.fiscal_year_id = fiscal_year_id;
...
//this is for death certificate list search
 function certificate_list_search() {
    ...
    to_date = $("#filter_to_date").val();
     ...
     $("#death_certificate_table").dataTable().fnSettings().ajax.data.fiscal_year_id = fiscal_year_id;
