...
$(function () {
    $("#present_district_txt").autocomplete({
        ...
        source: function(req, response){
            $("#present_district").val('জেলা');
            $("#present_district_id").val('');

            $("#present_upazila").val('উপজেলা');
            $("#present_upazila_txt").val('');
            $("#present_upazila_id").val('');

            $("#present_postoffice").val('পোষ্ট অফিস');
...
$(function () {
    $("#permanent_district_txt").autocomplete({
        ...
        source: function(req, response){
            ...
            $("#permanent_upazila").val('উপজেলা');
            $("#permanent_upazila_txt").val('');
            $("#permanent_upazila_id").val('');

            $("#permanent_postoffice").val('পোষ্ট অফিস');
    ...
    for(var i = 0; i <= key_index; i++){
        ...
        $("#present_district_txt_" + i).autocomplete({
            ...
            source: function(req, response){
                ...
                $("#present_district_" + j).val('জেলা');
                $("#present_district_id_" + j).val('');

                $("#present_upazila_" + j).val('উপজেলা');
                $("#present_upazila_txt_" + j).val('');
                $("#present_upazila_id_" + j).val('');

                $("#present_postoffice_" + j).val('পোষ্ট অফিস');
        ...
        $("#permanent_district_txt_" + i).autocomplete({
            ...
            minLength: 0,
            source: function(req, response){
                $("#permanent_district_" + j).val('জেলা');
                $("#permanent_district_id_" + j).val('');

                $("#permanent_upazila_" + j).val('উপজেলা');
                $("#permanent_upazila_txt_" + j).val('');
                $("#permanent_upazila_id_" + j).val('');

                $("#permanent_postoffice_" + j).val('পোষ্ট অফিস');
...
// office district
$(function () {
    $("#office_district_txt").autocomplete({
        autoFocus: true,
        minLength: 0,
        source: function(req, response){
            $("#office_district").val('জেলা');
            $("#office_district_id").val('');

            $("#office_upazila").val('উপজেলা');
            $("#office_upazila_txt").val('');
            $("#office_upazila_id").val('');

            $("#office_postoffice").val('পোষ্ট অফিস');
            $("#office_postoffice_txt").val('');
            $("#office_postoffice_id").val('');
        ...
        select: function(event, ui){
            $("#office_district").val(ui.item.label);
            $("#office_district_id").val(ui.item.id);
        }
    });
});
...
// office upazila
$(function () {
    $("#office_upazila_txt").autocomplete({
        autoFocus: true,
        minLength: 0,
        source: function(req, response){
            $("#office_upazila").val('উপজেলা');
            ...
            var parent_id = $("#office_district_id").val();
        ...
        select: function(event, ui){
            $("#office_upazila").val(ui.item.label);
            $("#office_upazila_id").val(ui.item.id);
        }
    });
});
...
// office postoffice
$(function () {
    $("#office_postoffice_txt").autocomplete({
        autoFocus: true,
        minLength: 0,
        source: function(req, response){
            $("#office_postoffice").val('পোষ্ট অফিস');
            ...
            var parent_id = $("#office_upazila_id").val();
        ...
        select: function(event, ui){
            $("#office_postoffice").val(ui.item.label);
            $("#office_postoffice_id").val(ui.item.id);
        }
    });
});
