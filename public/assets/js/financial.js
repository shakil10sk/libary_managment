...
var prottyon_table, fiscal_year_id, from_date, to_date;
 ...
 function applicant_list_search(){
    ...
    $("#prottyon_applicant_table").dataTable().fnSettings().ajax.data.fiscal_year_id = fiscal_year_id;
...
//this is for prottyon certificate list search
 function certificate_list_search() {
    ...
    $("#prottyon_certificate_table").dataTable().fnSettings().ajax.data.fiscal_year_id = fiscal_year_id;
