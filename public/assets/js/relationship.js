...
var family_table, fiscal_year_id, from_date, to_date;
 ...
 function applicant_list_search(){
    ...
    $("#family_applicant_table").dataTable().fnSettings().ajax.data.fiscal_year_id = fiscal_year_id;
            ...
            success:function(response){
                ...
                if(response['status'] == "success"){
                    ...
                    response['data'].forEach(function(data) { 
                        ...
                        if (data.id == 28)
                            option += '<option value ="' + data.id + '"> পারিবারিক সনদ</option>';
                ...
                preConfirm: function() {
                    ...
                    success: function(response) {
                        ...
                        swal({
                            ...
                            showConfirmButton: true,
                            confirmButtonText: '<a href="'+family_bangla_sonod_url+'/'+response.sonod_no+'" target="_blank">প্রিন্ট</a>',
                            closeOnConfirm: true,
...
//this is for family certificate list search
 function certificate_list_search() {
    ...
    to_date = $("#filter_to_date").val();
     ...
     $("#family_certificate_table").dataTable().fnSettings().ajax.data.fiscal_year_id = fiscal_year_id;
