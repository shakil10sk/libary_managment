...
function calculation() {
    ...
    total = parseInt(fee) - parseInt(discount) + Math.round(vat) + parseInt(signboard_vat) + parseInt(source_vat) + parseInt(sarcharge) + parseInt(due);
                    ...
                    success: function(response) {
                        ...
                        swal({
                            ...
                            cancelButtonText:'<a href="' + url +'/trade/due/bill?sno='+response.sonod_no+'">বকেয়া' +
                                ' এন্ট্রি</a>',
                            showConfirmButton: true,
                            confirmButtonText: '<a href="' + url +'/trade/bill/collection">কালেকশন</a>',
                            closeOnConfirm: true,
                            allowEscapeKey: false
                        });
