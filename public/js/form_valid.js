$(document).ready(function() {
    ...
    $('#woyarish').click(function () {
        ...
        if ($.trim($('#warish_name_bn').val()) == '' || $.trim($('#relation_bn').val()) == ''){
            ...
            $('#emptyError').html('');
            addRow(x, warish_name_bn, warish_name_en, relation_bn, relation_en, relation_age);
        }
    });
    ...
    function addRow(x, warish_name_bn, warish_name_en, relation_bn, relation_en, relation_age) {
        $('#warish_name_bn').val('');
        $('#warish_name_en').val('');
        $('#relation_bn').val('');
        $('#relation_en').val('');
